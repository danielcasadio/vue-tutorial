class Movie < ApplicationRecord
  ...
  has_one :watched_serie, class_name: 'Serie', foreing_key: 'last_watched_episode_id', dependant: :nullify
  ...
  validates :highlighted_episode

  private

  def highlighted_episode
    if self.serie.present? && self.highlighted == true
      errors.add(:highlight_episode, "It's not possible to highlight a serie episode")
    end
  end
end
